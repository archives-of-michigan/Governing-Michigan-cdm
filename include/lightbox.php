<link rel="stylesheet" type="text/css" href="<?= SEEKING_MICHIGAN_HOST ?>/stylesheets/jquery.lightbox-0.5.css" media="screen" />
...
<script type="text/javascript">
  function full_screen_image_url(alias, itnum, image_width, image_height, type) {
    ...
    return('http://cdm9006.cdmhost.com/cgi-bin/getimage.exe?CISOROOT=' + alias + '&amp;CISOPTR=' + itnum + '&amp;REC=1&amp;DMSCALE=' + scaling + '&amp;DMWIDTH=' + full_width + '&amp;DMHEIGHT=' + full_height + '&amp;type=.' + type);
  }
